...
describe("pluginsHookFactory", () => {
  ...
  describe("when the plugins hook factory is called with no plugins", () => {
    beforeEach(() => {
      pluginsHook = pluginsHookFactory();
    });

    it("should return null", () => {
      expect(pluginsHook).toBeNull();
    });
  });

  describe("when the plugins hook factory is called with an empty array of plugins", () => {
    beforeEach(() => {
      pluginsHook = pluginsHookFactory([]);
    });
  ...
  describe("when the plugins hook factory is called with plugins", () => {
    const plugins = [
